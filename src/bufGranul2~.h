...
// BUFFER SON
	t_garray *x_buf[NSBUF];				// le buffer~ son ( determine sa "readability" aussi )
...
//void bufGranul_nbuffer(t_bufGranul *x, float n);		// nombre de buffer son

// Bufffer enveloppe
void bufGranul_setenv(t_bufGranul *x, t_symbol *msg, short ac, t_atom * av);	// definition le buffer~ enveloppe
void bufGranul_envbuffer(t_bufGranul *x, float n);		// # du buffer env actif
void bufGranul_nenvbuffer(t_bufGranul *x, float n);		// nombre de buffer enveloppe
...
// Parametres
void bufGranul_sinterp(t_bufGranul *x, float n);		// interpollation dans la lecture du buffer
void bufGranul_poll(t_bufGranul *x, float n);		// nombres de voix en sorties
void bufGranul_clear(t_bufGranul *x);				// panique ! effacement des grains en cours
void bufGranul_nvoices(t_bufGranul *x, float n);			// definition du nombre de voix (polyphonie)
...
// DSP
void bufGranul_dsp(t_bufGranul *x, t_signal **sp);			// signal processing
